...
import { Users, Shield, ArrowLeft, Eye, EyeOff, LogIn } from 'lucide-react';

const BlockOfficerLogin: React.FC = () => {
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="glass-card p-8 fade-up">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-xl font-bold text-gov-50">Block Officer</h1>
                        <p className="text-sm text-gov-400 mt-1">Block-level analytics, monitoring & reporting</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-3 mb-4">
                            <p className="text-xs text-purple-400 font-medium mb-1">Demo Mode - Any credentials work!</p>
                        ...
                        <div className="flex items-center justify-between text-xs">
                            <label className="flex items-center gap-2 text-gov-400 cursor-pointer">
                                <input type="checkbox" className="rounded border-gov-600 bg-gov-800 text-purple-500 focus:ring-purple-500/30" />
                                Remember me
                            </label>
                ...
                <p className="text-center text-xs text-gov-400 mt-4">
                    Don't have an account? <Link to="/register/block-officer" className="text-purple-400 hover:text-purple-300">Register here</Link>
                </p>
...
export default BlockOfficerLogin;
